 ...
 * use the [com.lsn.lib.net.core.interceptors.EmptyBodyInterceptor] for your interceptor.
 *
 * ```
 ...
 * ```
 */
public class NoContentException constructor(public val code: Int, override val message: String? =
